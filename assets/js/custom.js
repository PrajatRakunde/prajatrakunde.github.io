...
(function( $ ){
	...
	/* ----------------------------------------------------------- */
		...
		$('.mu-skill-progress-bar').appear(function() {
			...
			$('.mu-j2ee-bar').LineProgressbar({
				percentage: 85,
				triggerOnce: true
			});


			$('.mu-corejava-bar').LineProgressbar({
				percentage: 90,
				triggerOnce: true
			});

			$('.mu-springboot-bar').LineProgressbar({
				percentage: 80,
				triggerOnce: true
			});
			...
			$('.mu-hibernate-bar').LineProgressbar({
				percentage: 80,
				triggerOnce: true
			});

			$('.mu-microservices-bar').LineProgressbar({
				percentage: 55,
				triggerOnce: true
			});
			...
			$('.mu-typescript-bar').LineProgressbar({
				percentage: 75,
				triggerOnce: true
			});
